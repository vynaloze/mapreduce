...
func (c *pingPongClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PongReply, error) {
	out := new(PongReply)
	err := c.cc.Invoke(ctx, "/mapreduce.PingPong/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingPongServer) Ping(context.Context, *PingRequest) (*PongReply, error) {
...
func _PingPong_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mapreduce.PingPong/Ping",
	}
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mapreduce.PingPong",
	...
	Metadata: "ping_pong/ping_pong.proto",
}
